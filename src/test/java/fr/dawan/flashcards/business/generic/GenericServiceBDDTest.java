...
class GenericServiceBDDTest {
	...
	void findAll_test() {
		...
		CardDto dto1 = new CardDto(0L,0,"JAVA","Qu'est qu'une dépendance ?","Une dépendance c'est...");
		CardDto dto2 = new CardDto(0L,0,"JAVA","Qu'est qu'une implémentation ?","Une implémentation c'est...");
	...
	void findById_test() {
		...
		CardDto dto = new CardDto(id,0,"JAVA","Qu'est qu'une dépendance ?","Une dépendance c'est...");
	...
	void saveOrUpdate_test() {
		Card card = new Card("Dependance", Category.JAVA,"Qu'est qu'une dépendance ?","Une dépendance c'est...");
		CardDto dto = new CardDto(1L,0,"JAVA","Qu'est qu'une dépendance ?","Une dépendance c'est...");
