...
public class InitData {
    ...
    public static void main(String[] args) {
        ...
        cardList.add(new Card("permissif", Category.DEFINITION, "Qu'est ce qu'une \"licence permissive\" ?", " Une licence permissive, ou licence open source permissive, se réfère à un type de licence qui accorde aux utilisateurs un large ensemble de droits pour utiliser, modifier et distribuer le logiciel. "));
        cardList.add(new Card("statique", Category.DEFINITION, "Qu'elles sont les concepts de terme \"statique\" ?", "Ces utilisations du terme \"statique\" partagent le concept de quelque chose qui est fixe, déterminé à l'avance, ou qui ne change pas dynamiquement pendant l'exécution du programme."));
        ...
        cardList.add(new Card("statique", Category.DEFINITION, "Qu'est ce qu'une \"méthode statique\" dans le contexte de POO ?", "Une méthode statique est une méthode liée à la classe plutôt qu'à une instance spécifique de la classe. Elle peut être appelée sans avoir besoin d'instancier un objet de la classe."));
        cardList.add(new Card("specifique", Category.DEFINITION, "Qu'est ce que le terme \"spécifique\" signifie ?", "En résumé, le terme \"spécifique\" est utilisé pour mettre en évidence ce qui est distinct, particulier ou propre à une personne, à un objet, à un groupe ou à une situation particulière dans un contexte donné."));
        ...
        cardList.add(new Card("annotation", Category.DEFINITION, "Qu'est ce qu'une\"@annotation\" ?", "Le terme @nnotation fait référence à des mécanismes permettant d'ajouter des métadonnées ou des informations supplémentaires à du code source, des documents ou d'autres éléments. Les annotations peuvent être utilisées dans divers langages de programmation, outils de développement, et même dans des contextes tels que la documentation et la modélisation."));
        ...
        cardList.add(new Card("audit", Category.DEFINITION, "Qu'est ce qu'un \"audit\" ?", "Audit informatique : Un examen des systèmes informatiques, des procédures et des contrôles de sécurité pour évaluer la protection des données, la conformité aux politiques de sécurité, et la résilience contre les menaces informatiques."));
        ...
        cardList.add(new Card("entitee", Category.DEFINITION, "Qu'est ce qu'une \"entité\" dans le contexte de POO ?", "En programmation orientée objet, une entité peut être une instance d'une classe. Les classes définissent des modèles pour créer des objets, et chaque objet créé à partir de ces modèles est considéré comme une entité."));
        ...
        cardList.add(new Card("variable", Category.DEFINITION, "Qu'est ce qu'une \"variable\" ?", "En programmation informatique, une variable est un espace de stockage nommé qui peut contenir une valeur ou une référence à une valeur. Les variables sont utilisées pour stocker et manipuler des données dans un programme."));
        ...
        cardList.add(new Card("back-end", Category.ARCHITECTURE, "Qu'est ce que le terme \"back-end\" signifie ?", "Le terme \"back-end\" se réfère à la partie invisible d'une application ou d'un site web, gérant les opérations en coulisses, comme la gestion des données, la logique métier et les interactions avec la base de données."));
        ...
        cardList.add(new Card("UUID", Category.SIGLE, "Que veut dire le sigle : UUID ?", "Translation: Universally Unique Identifier\n" +
                "Definition: A UUID is a 128-bit identifier that is globally unique, often used to uniquely identify information in distributed systems."));
        cardList.add(new Card("DTO", Category.SIGLE, "Que veut dire le sigle : DTO ?", "Translation: Data Transfer Object\n" +
                "Definition: A DTO is a design pattern used to transfer data between software application subsystems, containing only data attributes without business logic."));
        ...
        cardList.add(new Card("JPA", Category.SIGLE, "Que veut dire le sigle : JPA ?", "Java Persistence API : JPA est une spécification Java pour la gestion des données relationnelles dans les applications Java, offrant une manière standard d'interagir avec les bases de données en utilisant des objets Java."));
        cardList.add(new Card("GAV", Category.SIGLE, "Que veut dire le sigle : GAV ?", "Group ID, Artifact ID et Version. Pré-requis du POM.xml : nécessaire à une architecture Maven pour identifier de manière unique et localiser la dépendance d'un projet spécifique dans un référentiel."));
        ...
        cardList.add(new Card("JSON", Category.EXTENSION, "A quoi correspond cette extension : JSON", "JSON, ou JavaScript Object Notation, est un format d'échange de données léger, facile à lire et à écrire pour les humains, et facile à analyser et générer pour les machines."));
        cardList.add(new Card("XML", Category.EXTENSION, "A quoi correspond cette extension : XML", "eXtensible Markdown Langage, ou Langage de Balisage Extensible, est un langage de balisage qui définit des règles pour encoder des documents dans un format lisible à la fois par les humains et les machines."));
        ...
        cardList.add(new Card("trello", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Trello", "Trello est un outil de gestion de projet en ligne qui vous aide à organiser vos tâches et collaborer avec d'autres personnes."));
        cardList.add(new Card("jacoco", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : JaCoCo", "JaCoCo est un outil de mesure de la couverture de code, ce qui signifie qu'il vous aide à comprendre quelle partie de votre code est testée par vos tests automatisés."));
        cardList.add(new Card("surefire", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Surefire", "Surefire est un plugin de Maven qui s'occupe de l'exécution des tests unitaires de votre projet."));
        cardList.add(new Card("maven", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Maven", "Maven est un outil de gestion de projet qui vous aide à construire, gérer et documenter votre projet Java."));
        cardList.add(new Card("eclipse", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Eclipse", "Eclipse est un environnement de développement intégré (IDE) qui vous aide à écrire, compiler, et déboguer votre code."));
        cardList.add(new Card("intellij", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : IntelliJ", "IntelliJ est un environnement de développement intégré (IDE) développé par JetBrains"));
        cardList.add(new Card("jenkins", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Jenkins", "Jenkins est un outil d'intégration continue qui automatise le processus d'intégration, de test et de déploiement de logiciels."));
        cardList.add(new Card("sonarlint", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : Sonarlint", "SonarLint est un plugin d'analyse de code statique qui vous aide à détecter et corriger les problèmes de qualité du code pendant le développement."));
        cardList.add(new Card("sonarqube", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : SonarQube", "SonarQube est une plateforme d'analyse continue de la qualité du code qui fournit des informations détaillées sur la santé générale de votre code source."));
        cardList.add(new Card("postman", Category.SOFTWARE, "Quelle est la fonction de ce logiciel : POST Man", "Postman est un outil de développement d'API qui permet de tester, développer et documenter les API de manière efficace."));
        ...
        cardList.add(new Card("Java", Category.LANGAGE, "Citez moi trois particularités de ce langage : Java", "1.Portabilité et Indépendance de la Plateforme \n2.Orienté Objet \n3.Gestion de la Mémoire Automatique (Garbage collector)"));
        cardList.add(new Card("Javascript", Category.LANGAGE, "Citez moi trois particularités de ce langage : Javascript", "1.Langage de Programmation Côté Client \n2.Asynchrone et Orienté Événements \n3.Polyvalence et Utilisation Étendue (Dev Web Client Side && Server side {NodeJs} && IoT"));
