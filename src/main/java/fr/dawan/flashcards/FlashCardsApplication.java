	...
	public void run(String... args) throws Exception {
		...
		if (cardRepository.findAll().isEmpty()){
			cardRepository.saveAll(List.of(
					...
					new Card("JPA", Category.SIGLE,"Que veut dire le sigle : JPA ?",""),
					new Card("GAV", Category.SIGLE,"Que veut dire le sigle : GAV ?",""),
					new Card("JVM", Category.SIGLE,"Que veut dire le sigle : JVM ?",""),
					new Card("POO", Category.SIGLE,"Que veut dire le sigle : POO ?",""),
					new Card("DCU", Category.SIGLE,"Que veut dire le sigle : DCU ?",""),
					new Card("DC", Category.SIGLE,"Que veut dire le sigle : DC ?",""),
					new Card("DLL", Category.SIGLE,"Que veut dire le sigle : DLL ?",""),
